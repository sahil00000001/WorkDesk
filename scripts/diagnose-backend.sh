...
echo "├─────────────────────────────────────────────────────────────────────"
echo "│"
echo "│  Symptom  : POST /api/auth/login returns HTTP 500 for any registered"
echo "│             email address.  Unknown emails return 200 (correct, by"
echo "│             design) so the crash only happens when an OTP is about"
echo "│             to be emailed."
echo "│"
echo "│  Root Cause (confirmed)"
echo "│  ─────────────────────"
echo "│  podtech.com MX record → podtech-com.mail.protection.outlook.com"
echo "│  This means sahil.vashisht@podtech.com is a Microsoft Office 365"
echo "│  account, NOT a Gmail account."
echo "│"
echo "│  Current Vercel env vars (WRONG)"
echo "│    SMTP_HOST = smtp.gmail.com          ← wrong server for @podtech.com"
echo "│    SMTP_PASS = bcqtrlrkvfzthzgp        ← Gmail App Password, useless"
echo "│                                           for Office 365"
echo "│"
echo "│  Fix — Update these 2 env vars on Vercel (zoho-backend project)"
echo "│  ───────────────────────────────────────────────────────────────"
echo "│    SMTP_HOST  →  smtp.office365.com"
echo "│    SMTP_PORT  →  587                   (keep as-is)"
echo "│    SMTP_SECURE→  false                 (keep as-is)"
echo "│    SMTP_USER  →  sahil.vashisht@podtech.com  (keep as-is)"
echo "│    SMTP_PASS  →  <your actual Office 365 / Outlook password>"
echo "│    SMTP_FROM  →  Employee Portal <sahil.vashisht@podtech.com>"
echo "│"
echo "│  Extra step required — Enable SMTP AUTH for the mailbox"
echo "│  ────────────────────────────────────────────────────────"
echo "│  Microsoft disables SMTP AUTH by default on all new tenants."
echo "│  1. Go to admin.microsoft.com"
echo "│  2. Users → Active users → sahil.vashisht@podtech.com"
echo "│  3. Click Mail tab → Manage email apps"
echo "│  4. Check  ☑  Authenticated SMTP  → Save changes"
echo "│"
echo "│  After fixing env vars → Redeploy the backend on Vercel"
echo "│    Vercel Dashboard → zoho-backend → Deployments → Redeploy"
echo "│"
echo "│  Verify fix"
echo "│    curl -s -X POST $BASE/api/auth/login \\"
echo "│         -H 'Content-Type: application/json' \\"
echo "│         -d '{\"email\":\"admin@company.com\"}'"
echo "│    Expected → HTTP 200 + OTP email received in inbox"
echo "│"
echo "└─────────────────────────────────────────────────────────────────────"
